...
findtime  = 10                     |
banaction = xxx-POST-passwd-limit  -> ban action on /etc/fail2ban/action.d/  folder. there is /etc/fail2ban/action.d/xxx-POST-passwd-limit.conf
filter    = xxx-POST-passwd-limit  -> filter on /etc/fail2ban/filter.d/ folder. there is /etc/fail2ban/filter.d/xxx-POST-passwd-limit.conf
logpath   = /var/log/nginx/xxx-access.log -> fail2ban  is scanning log files to ban IP. so there is log file path 
